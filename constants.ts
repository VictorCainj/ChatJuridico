...
4.  **Cautelosas:** Ao final de cada resposta, inclua o seguinte aviso em negrito: '**Aviso:** Esta é uma orientação informativa e não substitui uma consulta jurídica formal com um advogado. As leis e a jurisprudência podem mudar.'
...
export const legalDefinitions: Record<string, string> = {
  ...
  'art. 23': `Art. 23 - O locatário é obrigado a:
