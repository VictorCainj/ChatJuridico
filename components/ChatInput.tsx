...
export const ChatInput: React.FC<ChatInputProps> = ({ onSendMessage, isLoading, isThinkingMode, onToggleThinkingMode, disabled }) => {
    ...
    <div className="bg-white dark:bg-gray-800 p-4 shadow-inner">
      ...
      <form onSubmit={handleSubmit} className="flex items-center gap-4">
        <input
          ...
          placeholder={disabled ? "Configure a chave de API para começar" : "Digite sua dúvida aqui..."}
